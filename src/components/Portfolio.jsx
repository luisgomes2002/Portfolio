  ...
  const projectsData = [
    {
      ...
      descKey: "pdesc1",
      stack:
        "TypeScript · React · Styled Components · Java · Spring Boot · MongoDB · Clean Architecture · Redis · AI ·  Google Vision · Google Cloud Storage · Strip ·  Docker · NGINX · Prometheus · Grafana",
